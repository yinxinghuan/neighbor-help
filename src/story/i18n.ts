...
const dictionary = {
  zh: {
    ...
    consistencyRecovery: '“{action}”这条推荐行动没有得到可靠结果，已从当前选项中移除。你仍在{name}，个人数值、物品和已经发生的事都没有改变；可以选择其余行动，或直接写下另一种做法。',
    checkSuccess: '成功',
    checkFailure: '失败',
  ...
  en: {
    ...
    consistencyRecovery: 'The recommended action “{action}” did not produce a reliable result and has been removed from the current options. You remain at {name}; personal stats, items, and established events are unchanged. Choose another available action or write a different one.',
