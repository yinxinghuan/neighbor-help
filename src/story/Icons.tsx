...
export type IconName = 'people' | 'map' | 'bag' | 'book' | 'folio' | 'board' | 'close' | 'back' | 'pen' | 'arrow' | 'image' | 'refresh' | 'volume' | 'volumeOff'
...
const paths: Record<IconName, React.ReactNode> = {
  ...
  board: <><rect x="4" y="4" width="16" height="16" rx="1.5"/><path d="M8 2.5v3M16 2.5v3M7.5 9h9M7.5 13h6M7.5 17h3"/><circle cx="17" cy="16.5" r="1.5"/></>,
