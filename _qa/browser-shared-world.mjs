...
await pageA.getByRole('button', { name: 'Shared board' }).click()
...
await pageA.getByRole('button', { name: /Claim the request and take the last umbrella/ }).click()
await pageA.getByText(/You confirm the claim on the board/).waitFor()
...
await pageB.getByRole('button', { name: /Claim the request and take the last umbrella/ }).click()
...
await pageB.getByRole('button', { name: 'Shared board' }).click()
